                      ...
                      if (is_dir($file)) {
                        ...
                        if(is_readable($file) && is_dir($file)){
                          ...
                          while (($file1 = readdir($folder1)) !== false){
                            if($file1 != "." && $file1 != "..")
                              echo '<a target="blank" href="'.$ndir.'/'.$file1.'">'.$ndir.'/'.$file1.'</a> '.substr(decoct(fileperms(fileperms($ndir.'/'.$file1)),3).'<br>' ;
                          }
                          closedir($folder1);
                          echo "----<br>";
                        ...
                        echo '<a target="blank" href='.$file.'>./'.$file.'</a> '.substr(decoct(fileperms($file)),2).'<br>';
                      }
                    }
                  }
                  closedir($folder);
